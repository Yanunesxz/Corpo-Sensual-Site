...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Lojistas */}
      <section className="mt-10 bg-stone md:mt-24">
        <div className="mx-auto grid max-w-[1600px] gap-8 px-5 py-12 md:px-8 md:py-24 lg:grid-cols-2 lg:gap-16">
