...
from (values
  ('0810', 'short-doll-regata-mescla-infantil', 'Short doll regata mescla infantil', 'Regata azul estampada com short listrado colorido, conjunto infantil feminino.', 'infantil', 1),
  ('0118', 'short-doll-regata-infantil', 'Short doll regata infantil', 'Regata azul com estampa de baleia e short azul-claro liso, conjunto infantil feminino.', 'infantil', 2),
  ('0130', 'pijama-bordado-de-manga-masculino', 'Pijama bordado de manga masculino', 'Camiseta de manga curta gola V com bordado no peito e short, em azul-marinho liso.', 'masculino', 3),
  ...
  ('0131', 'short-de-malha-masculino', 'Short de malha masculino', 'Short masculino de malha lisa em verde, com cós elástico; modelo sem camisa.', 'masculino', 5),
  ('0848', 'pijama-regata-canelado', 'Pijama regata canelado', 'Regata canelada bege com viés marrom e short marrom com cordão no cós.', 'feminino', 6),
  ('0115', 'short-doll-de-alca-em-malha', 'Short doll de alça em malha', 'Blusa de alça com estampa "Gelato" e short verde-oliva liso, em malha.', 'feminino', 7),
  ('2130', 'pijama-aberto-bordado-de-manga-masculino', 'Pijama aberto bordado de manga masculino', 'Camisa aberta de manga curta com botões e bordado no peito, com short, em azul-claro liso.', 'masculino', 8),
  ('0123', 'pijama-aberto-de-manga-bordado', 'Pijama aberto de manga bordado', 'Blusa aberta de manga curta com botões e bermuda, em verde-claro liso.', 'feminino', 9),
  ('0550', 'short-liganete-masculino', 'Short liganete masculino', 'Short masculino em liganete azul-marinho estampado, com cós elástico; modelo sem camisa.', 'masculino', 10),
  ...
  ('0126', 'camisola-bordada-aberta', 'Camisola bordada aberta', 'Camisola aberta com botões na frente e manga curta, verde-claro lisa, comprimento acima do joelho.', 'feminino', 12),
  ...
  ('0851', 'pijama-americano-liso', 'Pijama americano liso', 'Camisa de manga curta com gola, botões e vivo rosa, com short combinando, em rosa-claro.', 'feminino', 14),
